...
class DirectionTableSeeder extends Seeder
{
    ...
    public function run()
    {
       DB::table('directions')->insert([
           ...
           [
            'abr'=>'INfor',
            'libelle'=>'Institut National de Formation du Personnel des Établissements dETFP',
           ],
           [
            'abr'=>'DAF',
           ...
           [
            'abr'=>'DSI',
            'libelle'=>'Direction du Système dInformation',
           ],
           [
            'abr'=>'CGPP',
           ...
           [
            'abr'=>'CGPP',
            'libelle'=>'Coordonnateur Général des Programme et Des Projets ',
           ],
           [
            'abr'=>'DPSE',
            'libelle'=>'Direction de Planification et Suivi Valuation ',
